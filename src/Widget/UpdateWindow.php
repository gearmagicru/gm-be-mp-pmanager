...
/**
 * Виджет для формирования интерфейса обновления плагина.
 * 
...
class UpdateWindow extends Window
{
    ...
    /**
     * Маршрут заврешения обновления плагина.
     * 
     * @var string
     */
    public string $route = '';
    ...
    protected function init(): void
    {
        ...
        $this->ui        = 'light';
        $this->cls       = 'gm-mp-pmanager-update';
    ...
    /**
     * Возвращает шаги обновления плагина.
     * 
     * @return array
     */
    public function renderSteps(): array
    {
        ...
        foreach ($this->steps as $step) {
            ...
            $html .= '<div class="gm-mp-pmanager-update__step' . $active .'"><i class="fal fa-check"></i> ' . $title . '</div>';
        }
        return [
            'xtype' => 'container',
            'cls'   => 'gm-mp-pmanager-update__steps',
            'html'  => $html
        ];
    }
    ...
    public function renderFormItems(): array
    {
        return [
            ...
            [
                'xtype' => 'container',
                'cls'   => 'gm-mp-pmanager-update__notice',
                'html'  => '#{update.notice}'
            ],
            [
                'xtype' => 'hidden',
